        ...
        try:
            ...
            with ux_utils.print_exception_no_traceback():
                ...
                raise ValueError(
                    ...
                    f'metadata:"minimum_provisioned_size". '
                    f'Image may be in status: Failed/Pending. '
                    f'Image {image_id!r} is {image_size}GB, which is {size_comp} the specified disk_size: {self.disk_size}')
        return image_size
