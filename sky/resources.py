        ...
        for region, image_id in self._image_id.items():
            ...
            if image_size >= self.disk_size:
                with ux_utils.print_exception_no_traceback():
                    ...
                    raise ValueError(
                        f'Image {image_id!r} is {image_size}GB, which is {size_compare} '
                        f'the specified disk_size: {self.disk_size} GB. Please specify '
                        'a larger disk_size to use this image.')
