...
```python
def _get_source_and_name(override_args: Dict, metadata: Dict):
    """Returns source and name.

    Args:
        override_args (Dict): Override arguments.
    ...
    # If the source is a cloud URL, set the name to None.
