...
.. note::
    ...
    For Macs, macOS >= 10.15 is required to install SkyPilot. Apple Silicon-based devices (e.g. Apple M1) must run :code:`pip uninstall g# Add relevant installation instructions or content herepcio; conda install -c conda-forge grpcio=1.43.0` prior to installing SkyPilot.
